<template>
  <v-content>
    <v-container>
      <h2>bazaaar(バザー)サービス利用規約</h2>
      この規約は、お客様が、BlockBase株式会社（以下「当社」）が提供する「bazaaar(バザー)」サービス（以下「本サービス」）をご利用頂く際の取扱いにつき定めるものです。本規約に同意した上で本サービスをご利用ください。
      <h3>第1条（定義）</h3>
      本規約上で使用する用語の定義は、次に掲げるとおりとします。 用語 定義 （1）本サービス
      当社が運営するサービス及び関連するサービス （2）本サイト 本サービスのコンテンツが掲載されたウェブサイト
      （3）本コンテンツ
      本サービス上で提供される文字、音、静止画、動画、ソフトウェアプログラム、コード等の総称（投稿情報を含む）
      （4）利用者 本サービスを利用する全ての方 （5）登録利用者 本サイトの利用者登録が完了した方 （6）ID
      本サービスの利用のために登録利用者が固有に持つ文字列 （7）パスワード IDに対応して登録利用者が固有に設定する暗号
      （8）投稿 登録利用者が文章、文字列、画像、コメント等を掲載する行為 （9）投稿情報
      登録利用者が投稿等により掲載した文章、文字列、画像、コメント等の情報の総称 （10）知的財産
      ...
      本サービスはベータ版・開発中のものであり、その性質上、バグや瑕疵、誤動作など、正常に利用できない症状等の不具合を含み得るものとして提供されるものであること。
      当社は、利用者に対し、本サービスの正確性・完全性・有用性・信頼性・無害性等に関していかなる保証もするものではないこと。
      <h3>第3条（本規約への同意）</h3>
      利用者は、本利用規約に同意頂いた上で、本サービスを利用できるものとします。
      利用者が、本サービスをウェブブラウザを介し、本サービスを利用した時点で、利用者と当社との間で、本規約の諸規定に従った利用契約が成立するものとします。
      ...
      <h3>第5条（アカウントの管理）</h3>
      利用者は、利用に際して登録した情報（以下「登録情報」。メールアドレスやID・パスワード等を含みます）について、自己の責任の下、任意に登録、管理するものとします。利用者は、これを第三者に利用させ、または貸与、譲渡、名義変更、売買などをしてはならないものとします。
      ...
      <h3>第6条（ウォレット）</h3>
      利用者は、本サービスをウェブブラウザ経由で利用する場合、当社の指定するブラウザ及びデジタル・アセット及び暗号通貨の保管機能（以下「ウォレット」）を利用するものとします。
      利用者は、本サービスをウェブブラウザ経由で利用する場合、同端末中のウォレット機能その他当社の指定するウォレットを利用するものとします。
      ウォレットの管理は、利用者自身の端末機器上の記憶領域を利用して行われます。当社は、オンライン上での管理手段を提供しません。ウォレットへの入金及びウォレットからの出金は、当社所定の時期及び方法により行われるものとします。
      <h3>第7条（手数料について）</h3>
      本サービスの利用には、当Webサイト内に明示する当社所定の手数料がかかります。手数料は当社の判断で変更できるものとし、ユーザーは予めこれを承諾するものとします。
      <h3>第8条（アカウント等の管理）</h3>
      利用者は、自身の端末機器、アカウント、秘密鍵及びパスワード（以下「アカウント等」。）を第三者に使用させ、又は第三者と共有してはならないものとします。当社は、利用者の端末機器及び秘密鍵を一切管理しません。
      利用者は、本サービスの利用にあたり、自身のアカウント等を自らの責任において管理するものとし、自身のアカウント等を使用してなされた行為について、一切の責任を負うものとします。
      当社は、利用者自身のアカウント又は秘密鍵を使用してなされた行為について、その実際の利用者が誰であるかを問わず、すべて、当該アカウントが付与され又は当該秘密鍵を管理する利用者による行為とみなします。
      当社は、利用者の使用する端末機器の故障、紛失、第三者からのマルウェア、スパイウェア、ウィルス、ハッキング・クラッキング等による攻撃、アカウント等の管理不備及び使用上の過誤、又は第三者によるアカウント等の使用等により、利用者がウォレット内の暗号通貨やデジタル・アセットの喪失、使用不能を含む損害を蒙った場合であっても、当社に故意又は重過失ある場合を除き、一切の責任を負いません。
      利用者は、自身のアカウント等が第三者により不正に利用されるおそれがある場合、速やかに当社に通知するとともに、当該の不正な利用を回避するための必要な措置をとるものとします。
      当社は、利用者が自身のアカウント等を紛失又は失念したことにより、利用者に生じうる不利益（ウォレット内の暗号通貨その他本サービスにおいて実現される一切の状態（以下「利用データ等」とします。）及び本サービスに関連するブロックチェーン上の情報が失われることを含みます。）について、一切の責任を負いません。
      利用者は、利用者の端末機器、秘密鍵及びパスワードのいずれか一つでも欠けた場合、利用者はウォレットを使用することが不可能となること、並びに、当社が当該ウォレットに関して何らかの救済を行うことが不可能であることを予め了解するものとします。
      <h3>第9条（有償サービス）</h3>
      当社は、利用者に対し、本サービスにおいて、有償のサービスを提供することがあります。当社は有償サービスの一部として、利用者間の行為について手数料その他の費用を定めることがあります。
      利用者は、当社が定める価格及び決済手段によってのみ、当社に対し、有償サービスの購入及び支払いをすることができます。
      利用者と当社以外の第三者との間で、支払いに関する紛争が生じた場合、利用者は当該第三者との間でその解決を図るものとし、当社は、当社に故意又は重過失ある場合を除き、一切の責任を負いません。
      当社は、利用者が購入した有償サービスおよび有償データを、当社が別途定める場合、又は法令上必要がある場合を除き払い戻しません。
      <h3>第10条（費用の負担）</h3>
      本サービスの利用にあたり必要なソフトウェアの購入の費用、データの利用料金等の通信料金、電気料金その他一切の費用は、利用者が自己の責任において支払うものとします。
      <h3>第11条（デジタル・アセット）</h3>
      本サービスにおいて「デジタル・アセット」とは、利用者が本サービス上で保有可能な情報であり、本サービス上で定義されるものを指します。
      利用者は、デジタル・アセットを他の利用者に対し、当社が定める方法により譲渡することができます。
      <h3>第12条（個人情報等の取り扱い）</h3>
      個人情報及び利用者情報については、当社が別途定める「<nuxt-link to="/privacy">プライバシーポリシー</nuxt-link
      >」に則り、適正に取り扱うこととします。
      <h3>第13条（禁止行為）</h3>
      ...
      当社または第三者の財産を侵害する行為、または侵害する恐れのある行為 当社または第三者に経済的損害を与える行為
      当社または第三者に対する脅迫的な行為 利用者が、以下の情報を投稿すること
      ...
      ⑤事実に反する、または存在しないと分かっている情報 ⑥利用者自身がコントロール可能な権利を持たない情報
      ⑦第三者の著作権を含む知的財産権やその他の財産権を侵害する情報、公共の利益または個人の権利を侵害する情報
      ⑧わいせつ、児童ポルノまたは児童虐待にあたる画像、文書等の情報 ⑨医師法などの法令に違反する情報
      ⑩その他当社が不適切と判断する情報 コンピューターウィルス、有害なプログラムを仕様またはそれを誘発する行為
      本サービス用インフラ設備に対して過度な負担となるストレスをかける行為
      当サイトのサーバーやシステム、セキュリティへの攻撃
      当社提供のインターフェース以外の方法で当社サービスにアクセスを試みる行為
      一人の利用者が、複数の利用者IDを取得する行為 上記の他、当社が不適切と判断する行為
      <h3>第14条 （コンテンツの取り扱い）</h3>
      利用者は､本サービスのコンテンツを当社の定める範囲内でのみ使用することができるものとします｡
      本サービスで提供される全てのコンテンツに関する権利は当社が有しており､利用者に対し､当社が有する特許権､実用新案権､
      意匠権､商標権､著作権､その他知的財産権の実施または使用許諾をするものではありません｡
      ...
      利用者は、AppStore、GooglePlay等のサービスストアなどの利用規約および運用方針の変更等に伴い、本サービスの一部又は全部の利用が制限される可能性があることを予め了承するものとします。
      ...
      第１項乃至前項の規定は、当社に故意または重過失が存する場合又は契約書が消費者契約法上の消費者に該当する場合には適用しません。
      前項が適用される場合であっても、当社は、過失による行為によって利用者に生じた損害のうち、特別な事情から生じた損害については、一切賠償する責任を負わないものとします。
      ...
      本サービスで他の利用者が投稿した情報の正確性について、当社は保証しません。当社は、本サービスに掲載されている情報についての紛争及びトラブルについて一切の責任を負いません。
      <h3>第16条（広告の掲載について）</h3>
